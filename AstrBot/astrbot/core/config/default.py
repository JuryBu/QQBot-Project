            ...
            "segmented_reply": {
                ...
                "items": {
                    ...
                    "platform_settings.segmented_reply.interval_method": {
                        "description": "间隔方法。",
                        "hint": "random 为随机时间，log 为根据消息长度计算，adaptive 为根据字数自适应延迟。",
                        "type": "string",
                        "options": ["random", "log", "adaptive"],
                    },
                    ...
                    "platform_settings.segmented_reply.merge_threshold": {
                        "description": "短句合并阈值",
                        "type": "int",
                        "hint": "相邻短句字数之和小于此值时合并为一条，0 表示不合并。默认 80。",
                    },
                    "platform_settings.segmented_reply.adaptive_delays": {
                        "description": "自适应延迟档位",
                        "type": "object",
                        "hint": "short/medium/long 对应短句/中句/长句的延迟范围（格式: 最小,最大）。",
                    },
                    "platform_settings.segmented_reply.emoji_send_after_segment": {
                        "description": "表情包插入位置",
                        "type": "int",
                        "hint": "第几条分段消息之后插入表情包。默认 1（第一条消息后）。如果分段数不足则插在最后。",
                    },
                    "platform_settings.segmented_reply.emoji_probability": {
                        "description": "表情包发送概率",
                        "type": "float",
                        "hint": "0~1 之间，0=不发 1=必发。默认 0.7（70%概率）。",
                    },
                    "platform_settings.segmented_reply.max_segments": {
                        "description": "\u6700\u5927\u5206\u6bb5\u6570",
                        "type": "int",
                        "hint": "\u56de\u590d\u6d88\u606f\u6700\u591a\u5206\u6210\u51e0\u6761\u53d1\u9001\uff0c\u8d85\u51fa\u7684\u5f3a\u5236\u5408\u5e76\u3002\u9ed8\u8ba4 3\uff0c0 \u8868\u793a\u4e0d\u9650\u5236\u3002",
                    },
                },
            },
            "ltm": {
